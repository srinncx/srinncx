# 💫 About Me:
🔭 Currently hacking on  <br>RTL modules and digital systems in Verilog, with a strong focus on clean design and SystemVerilog-based verification.<br><br>👯 Looking to collaborate on  <br>Open-source ASIC / FPGA projects, RTL development, verification flows, and hardware-software co-design.<br><br>🤝 Looking for help with  <br>Scaling complex RTL designs, advanced verification techniques, and performance/power optimization on FPGA.<br><br>🌱 Currently learning  <br>Reconfigurable computing and ML architectures on FPGA.  <br>Also an avid Linux user who enjoys scripting, toolchains, and the occasional Linux ricing rabbit hole 🐧✨<br>
